...
print "Sample Name:    " +  "dy_jetsToLL_PU40bx50"
print "Sample DAS DIR: " +  "/DYJetsToLL_M-50_13TeV-madgraph-pythia8/Spring14miniaod-141029_PU40bx50_PLS170_V6AN2-v1/MINIAODSIM"
print ""
print ""
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("stage_1_"+"dy_jetsToLL_PU40bx50"+".root") )
