...
#s = Samples_v2.doubleMuon_RunB_MINIAOD
#s = Samples_v2.ggToHToMuMu_PU40bx50
s = Samples_v2.dy_jetsToLL_PU40bx50


# open a file for writing
outfile = open('dimuanalyzer_for_crab.py', 'w')
...
for line in file:
    ...
    if 's.jsonfiles[1]' in line and s.isData: 
        line = line.replace('s.jsonfiles[1]', '\"' + s.jsonfiles[1] + '\"')
...
outfile = open('crab_auto_submit.py', 'w')
